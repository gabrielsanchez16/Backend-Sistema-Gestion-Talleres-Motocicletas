...
const create = async (req, res) => {
    const { title,date,description,recommendations,price,id_motorcycle,id_mechanic } = req.body;
    try {
        const newWorkOrder = await createWorkOrder(title,date,description,recommendations,price,id_motorcycle,id_mechanic);
        res.status(201).json({
...
const updated = async (req, res) => {
    const { id,title,date,description,recommendations,price,id_motorcycle,id_mechanic } = req.body;
    ...
    try {
        const updatedWorkOrder = await updateWorkOrder(id,title,date,description,recommendations,price,id_motorcycle,id_mechanic);
        res.status(200).json({
